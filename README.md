...
1. One is running the Mesh on the Thingy:52 devices - _this is the part covered in this project_  
2. The other part is focused on having the Mesh on the nRF52840
